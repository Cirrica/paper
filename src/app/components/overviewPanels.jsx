    ...
    <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
      ...
      <div className="col-span-1 grid grid-cols-1 gap-5 lg:col-span-3 lg:grid-cols-2">
        ...
        >
          ...
          <div className="mt-5">
            <button className="w-full rounded-lg bg-gradient-to-r from-gold to-gold-soft py-2 font-poppins font-medium text-black">View all Tournament</button>
          </div>
        </Panel>
        ...
        >
          ...
          <div className="mt-5">
            <button className="w-full rounded-lg bg-gradient-to-r from-gold to-gold-soft py-2 font-poppins font-medium text-black">Explore all Stocks</button>
          </div>
        </Panel>
      </div>
    </div>
