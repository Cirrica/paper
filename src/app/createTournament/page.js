...
const prizeMultiplierOptions = [
  ...
  { value: '250X', title: '250X', description: 'High risk, great return' },
  {
    value: '500X',
    title: '500X',
    description: 'Very high risk, excellent returns',
  },
  {
    value: '1000X',
    title: '1000X',
    description: 'Maximum risk, maxima reward',
  },
];
...
export default function CreateTournament() {
  ...
  const handleSubmit = (event) => {
    ...
    if (Object.keys(validationErrors).length > 0) {
      ...
      setStatus({
        type: 'error',
        message: 'Double-check the highlighted fields before moving on.',
      });
      return;
    }
    ...
    setStatus({
      ...
      message:
        action === 'draft'
          ? 'Saving your draft configuration...'
          : 'Saving your tournament blueprint...',
    });
  ...
  const estimatedPrizePool = Math.max(
    entryFeeValue * maxParticipantsValue * 0.9,
    0
  );
              ...
              >
                <section className='w-full max-w-[44rem] rounded-xl border border-panel-border bg-panel p-6 shadow-lg shadow-black/30'>
                  ...
                  <div className='mt-6 space-y-3'>
                    <div>
                      <label
                        className='font-poppins text-sm font-thin leading-snug text-white'
                      ...
                      />
                      {errors.name && (
                        <p className='mt-2 font-poppins text-xs text-danger'>
                          {errors.name}
                        </p>
                      )}
                    </div>
                ...
                <section className='w-full max-w-[44rem] rounded-xl border border-panel-border bg-panel p-6 shadow-lg shadow-black/30'>
                  ...
                  <div className='mt-6 space-y-8'>
                    <div className='grid gap-5 md:grid-cols-2'>
                      <div>
                        <label
                          className='font-poppins text-sm font-normal leading-snug text-white'
                          htmlFor='duration'
                        >
                          Duration
                        </label>
                          ...
                          >
                            {durationOptions.map((option) => (
                              <option
                                key={option.value}
                                value={option.value}
                                className='bg-panel font-thin text-white'
                              >
                                {option.label}
                              </option>
                            ))}
                    ...
                    <div>
                      <div className='flex flex-col gap-1'>
                        <h3 className='font-poppins text-lg font-semibold leading-tight tracking-wider text-white'>
                          Prize Multiplier
                        </h3>
                      </div>
                      ...
                      <div className='mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-3'>
                        {prizeMultiplierOptions.map((option) => {
                          const isActive =
                            formData.prizeMultiplier === option.value;
                    ...
                    {advancedSettingFields.map((setting) => (
                      ...
                      >
                        <div className='space-y-2'>
                          <p className='font-poppins text-base font-medium leading-snug text-white'>
                            {setting.label}
                          </p>
